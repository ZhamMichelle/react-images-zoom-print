...
var print = (function (fill) {
	return "<svg fill=\"" + fill + "\" width=\"40px\" height=\"40px\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 650 400\"><path d=\"M416.291 104.057h-43.644V10c0-5.523-4.477-10-10-10H107.54c-5.523 0-10 4.477-10 10v94.057H53.896c-21.947 0-39.802 17.855-39.802 39.802v180.006c0 5.523 4.477 10 10 10H97.54v126.322c0 5.523 4.477 10 10 10h255.107c5.523 0 10-4.477 10-10V333.865h73.446c5.523 0 10-4.477 10-10V143.859c0-21.947-17.855-39.802-39.802-39.802zM117.54 20h235.107v84.057H308.87V60.35c0-5.523-4.477-10-10-10s-10 4.477-10 10v43.707h-43.777V60.35c0-5.523-4.477-10-10-10s-10 4.477-10 10v43.707h-43.777V60.35c0-5.523-4.477-10-10-10s-10 4.477-10 10v43.707H117.54V20zm235.107 230.684H117.54v-11.458c0-10.919 8.883-19.802 19.802-19.802h195.503c10.919 0 19.802 8.883 19.802 19.802v11.458zm0 199.503H117.54V270.684h235.107v179.503zm83.446-136.322h-63.446v-74.639c0-21.947-17.855-39.802-39.802-39.802H137.342c-21.947 0-39.802 17.855-39.802 39.802v74.639H34.093V143.859c0-10.919 8.883-19.802 19.802-19.802h362.396c10.919 0 19.802 8.883 19.802 19.802v170.006z\"/><path d=\"M395.497 151.836c-5.79 0-10.5 4.71-10.5 10.5s4.71 10.5 10.5 10.5 10.5-4.71 10.5-10.5c0-5.789-4.71-10.5-10.5-10.5zM355.497 151.836c-5.79 0-10.5 4.71-10.5 10.5s4.71 10.5 10.5 10.5 10.5-4.71 10.5-10.5c0-5.789-4.71-10.5-10.5-10.5zM314.963 400.311h-159.74c-5.523 0-10 4.477-10 10s4.477 10 10 10h159.74c5.523 0 10-4.477 10-10s-4.477-10-10-10zM314.963 350.435h-159.74c-5.523 0-10 4.478-10 10 0 5.523 4.477 10 10 10h159.74c5.523 0 10-4.477 10-10 0-5.522-4.477-10-10-10zM314.963 300.56h-79.87c-5.523 0-10 4.477-10 10s4.477 10 10 10h79.87c5.523 0 10-4.477 10-10s-4.477-10-10-10z\"/></svg>"
});

var icons = { arrowLeft: arrowLeft, arrowRight: arrowRight, close: close, zoomIn: zoomIn, zoomOut: zoomOut, rotateLeft: rotateLeft, rotateRight: rotateRight, save: save, print: print };
...
function ToolbarAction(_ref, _ref2) {
	...
	return React.createElement(
		...
		_extends({
			type: 'button',
			className: css$1(classes.actionButton),
			onClick: onClick,
			onTouchEnd: onClick
		}, props),
		React.createElement(Icon, { fill: !!theme$$1.toolbarAction && theme$$1.toolbarAction.fill || theme.toolbarAction.fill, type: icon })
	);
}
...
var Footer = function (_React$Component) {
	...
	createClass(Footer, [{
		...
		value: function render$$1() {
			...
			var classes = StyleSheet$1.create(deepMerge(defaultStyles$3, this.context.theme));
			...
			if (zoomable) {
				featureNodeArr = featureNodeArr.concat([React.createElement(
					...
					{
						key: 'zoomIn',
						className: css$1(classes.footerActionBtn) },
			...
			if (printable) {
				featureNodeArr = featureNodeArr.concat([React.createElement(
					...
					React.createElement(ToolbarAction, {
						icon: 'print',
						onClick: function onClick() {
							_this2.handleAction(ActionType.print);
						}
					})
				)]);
			}
			...
			return React.createElement(
				...
				React.createElement('div', { className: css$1(classes.footerActions) })
			);
		}
	}]);
	return Footer;
		...
		value: function handleAction(type) {
			switch (type) {
				...
				case ActionType.print:
					this.props.print && this.props.onPrint(this.props.currentImage, { zoom: this.state.scaleX, rotation: this.state.rotate });
					break;
				default:
					break;
			}
